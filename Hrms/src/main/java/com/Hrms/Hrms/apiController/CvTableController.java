...
public class CvTableController {
	...
	@RequestMapping("/candidateWithCvTables")
	public DataResult<List<CandidateWithCvTable>> candidateWithCvTables(int id){
		return this.cvTableService.candidateWithCvTables(id);
	}
